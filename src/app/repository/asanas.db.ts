...
export const ASANAS: DocumentModel[] = [
  {
    title: 'Marjari - Macska',
    type: 'asana',
    image: {src: 'marjari.jpg', dir: 't'},
    src: 'https://www.yogaindailylife.org/system/hu/1-szint/sarva-hita-%C3%A1szan%C3%A1k-1-r%C3%A9sz/marjari',
    content: '<p>' +
      'Lazítja, ezáltal hajlékonnyá és rugalmassá teszi az izmokat a gerinc mentén. Ezenkívül jó hatású az emésztőrendszerre és különösen a női szervekre (enyhíti a menstruációs görcsöket), alkalmas a mély hasi és mellkasi légzés elsajátítására.<br>' +
      '<br>' +
      'Végezz 3 kört.' +
      '</p>'
  },
  {
    ...
    src: 'https://www.yogaindailylife.org/system/hu/1-szint/sarva-hita-%C3%A1szan%C3%A1k-6-r%C3%A9sz/csavar%C3%A1s-felh%C3%BAzott-l%C3%A1bbal',
    content: '<p>' +
      'Lazítja a nyakat és az egész hátat, javítja a gerinc és a csípőízület hajlékonyságát és hatásos csípő-, valamint keresztcsonti ízületi bántalmak ellen.<br>' +
      '<br>' +
      'Végezz mindkét változatból 3-3 kört.<br>' +
      '<br>' +
      '<span class="red">Vigyázat!!! Heveny porckorongbántalmak esetén az a és a b változat is mellőzendő.</span>' +
      '</p>'
  },
  {
    ...
    content: '<p>' +
      'Ellazítja és megnyugtatja a testet, a légzést és az elmét. Lazítja és erősíti a hátizomzatot, mozgathatóbbá teszi a vállízületet. Segíti a légzőizmok munkáját a mellkas oldalsó részében.<br>' +
      '<br>' +
      'Végezd el ötször a gyakorlatot.' +
      '</p>'
  },
  {
    ...
    content: '<p>' +
      'Nyújtja a hát alsó részét és a csípőizomzatot. Segít szorulás, bélpuffadás és egyéb emésztési zavarok esetén, felfrissíti a szervezetet.<br>' +
      '<br>' +
      'Végezz mindkét lábbal 3-3 kört.' +
      '</p>'
  },
  {
    title: 'Malomkörzés',
    ...
    content: '<p>' +
      'Hajlékonyabbá teszi a csípőízületet és erősíti a hasizmokat. A farizmokra gyakorolt hatása leginkább lazító masszázshoz hasonlítható. Élénkíti a vérkeringést és jó hatású a manipura csakrára.<br>' +
      '<br>' +
      'Végezd mindkét irányba 10-szer.<br>' +
      '<br>' +
      '<span class="red">Vigyázat!!! Hasműtét után, valamint porckorongbántalmak, isiászra való hajlam és terhesség esetén a gyakorlat mellőzendő.</span>' +
      '</p>'
  },
  {
    ...
    content: '<p>' +
      'Lazítja a tarkót, valamint a nyak- és a válltájékot.<br>' +
      '<br>' +
      'Végezd el mindhárom változatot 5-ször.<br>' +
      '<br>' +
      '<span class="red">Vigyázat!!! Ha a fej hátrafelé történő mozgatása fájdalommal jár, akkor csak az első félkört gyakoroljuk. Szédülés vagy nyakcsigolyapanaszok esetén ne gyakoroljuk.</span>' +
      '</p>'
  },
  {
    ...
    content: '<p>' +
      'Erősíti a has- és lábizomzatot. Javítja a csípőízület és a térd mozgathatóságát. Fokozza a vérkeringést, különösen a lábakban, hatásos visszerek kialakulása ellen. Lazítja a csípő-, térd- és lábízületet, javítja a vérellátásukat. Előkészíti a meditációs ülőhelyzetet.<br>' +
      '<br>' +
      'Végezd el változatonként 5-10-szer mindkét irányba.<br>' +
      '<br>' +
      '<span class="red">Vigyázat!!! Ágyékcsigolya- panaszok esetén tegyük a kezünket a medencénk alá.</span>' +
      '</p>'
  },
  {
    title: 'Pillangó',
    ...
    content: '<p>' +
      'Előkészíti a meditációs ülőhelyzetet. Lazítja a csípőízületet és javítja vérellátását.<br>' +
      '<br>' +
      'Végezd kb. 1 percig.' +
      '</p>'
  },
  {
    ...
    content: '<p>' +
      'Segít emésztési zavarok, felfúvódás és hátfájás esetén. Nyújtja az izmokat az ágyékcsigolyák és csípőízület környékén. Fejleszti a lábak stabilitását, az egyensúlyérzéket és az összpontosító képességet.<br>' +
      '<br>' +
      'Mindkét lábbal végezd el 3-szor.' +
      '</p>'
  },
  {
    ...
    content: '<p>' +
      'A Khatu Pranam egyensúlyt teremt testi, lelki és szellemi működésünkben.<br>' +
      '<br>' +
  ...
  },
  {
    ...
    content: '<p>' +
      'A nadi az éltető energiát, érzéseket közvetíti a finom- és a durva fizikai testben. A sodhana finomítást, tisztítást, így a nadi sodhana az energia- és idegpályák megtisztítását jelenti. Ezen légzés lényege, hogy csak egy orrlyukon keresztül történik a légzés. Tisztítja a légutakat. A mély légzés révén oxigénnel dúsítja a vért. Erősíti a légzőszerveket, kiegyensúlyozza az idegrendszert, hatásos idegesség ellen és enyhíti a fejfájást.<br>' +
      '<br>' +
      'Végezz 20 kört mindkét orrjáraton.<br>' +
      '<br>' +
      '<span class="red">Vigyázat!!! Étkezés után nem javasolt. Mindig orron át történjen a légzés, erőlködés nélkül. Ha az orrjáratok blokkoltak (pl. nátha esetén), akkor végezhető mentálisan.</span>' +
      '</p>'
  },
  {
